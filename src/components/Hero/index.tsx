...
const Hero = () => {
  return (
    <>
      ...
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white pb-16 pt-[120px] dark:bg-gray-dark md:pb-[120px] md:pt-[150px] xl:pb-[0px] xl:pt-[100px] 2xl:pb-[200px] 2xl:pt-[0px]"
      >
